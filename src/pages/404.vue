    ...
    <div class="error-content">
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          <div class="pic-error">
            <img alt="404" class="pic-error-parent" src="@/assets/error/404.png" />
            <img alt="404" class="pic-error-child left" src="@/assets/error/cloud.png" />
            <img alt="404" class="pic-error-child" src="@/assets/error/cloud.png" />
            <img alt="404" class="pic-error-child" src="@/assets/error/cloud.png" />
          </div>
        </el-col>
...
const headline = ref<string>('页面没有找到');
const info = ref<string>('当前帐号没有页面权限,请联系管理员。');
